...
class ServiceMedicinesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('service-medicines.index')->with('success', 'Service Medicines is created successfully');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('service-medicines.index')->with('success', 'Service Medicines is updated successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('service-medicines.index')->with('success', 'Service Medicines is deleted successfully');
    }
}
